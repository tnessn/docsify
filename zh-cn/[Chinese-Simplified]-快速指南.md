...
* 请下载 [Samurai 钱包](https://download.platon.network/0.3/samurai-windows-x86_64-0.3.0.zip)客户端，并移步[这里](zh-cn/[Chinese-Simplified]-Samurai-钱包)根据提示安装后连接。
* 使用交互式命令行工具 [了解更多](zh-cn/cmd-line-interface/_javascript-console)
